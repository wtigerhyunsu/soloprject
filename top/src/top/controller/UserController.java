...
//			System.out.println(userDate);
			...
			String imgname = attch.getMf().getOriginalFilename();
...
//				user = new UserVO(userID, userPwd, userName, userAdd, userPhone, userMail, userDate, position, adcheck);
	...
	@RequestMapping("/setlog.top")
	public ModelAndView alerterror(HttpServletRequest req, HttpServletResponse res) {
...
//		session.setAttribute("loginId", id);
	...
	@RequestMapping("/change.top")
	public ModelAndView change(ModelAndView mv, HttpServletRequest request) {

	
		mv.addObject("center", "../requestadd/requestadd1");
		mv.setViewName("main/main");
