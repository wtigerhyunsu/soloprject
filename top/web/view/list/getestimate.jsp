...
<script>
	...
	function estimate(estimateNO, userID) {
		console.log(estimateNO + userID);
		var data = {
		...
		$.ajax({
			...
			url : "estimatedata.top",
			data : data,
			contentType : "application/json; charset=UTF-8",
			success : function(data) {
				console.log(data)
				$(".modal-body #userID").val(data.userID);
				$(".modal-body #epay").val(data.epay);
			...
			<div class="modal-content">
				<div class="modal-header no-bd">
					<h5 class="modal-title">
						<span class="fw-mediumbold" id="userID"> </span> <span
							class="fw-light"> </span>
					</h5>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6 pr-0">
							<div class="form-group form-group-default">
								<label>견적 금액</label> <input id="epay" name="epay" type="text"
				...
				<div class="modal-footer no-bd">
					<button type="button" id="addRowButton" class="btn btn-primary"
						data-toggle="modal" data-dismiss="modal">Add</button>
		...
		<div class="page-inner">
			<div class="row">
				<div class="col-md-12">
					...
					<c:forEach var="i" items="${getestimateListData }">
						<section class="card mt-4">
							<div class="list-group list-group-messages list-group-flush">
								<div class="list-group-item unread">
									<div class="list-group-item-figure">
										<span class="rating rating-sm mr-3"> <input
											type="checkbox" id="star1" value="${i.estimateNO }">
											<label for="star1"> <span class="fa fa-star"></span>
										</label>
										</span>
									</div>
										...
										<div class="row">
											<div class="col-12 col-lg-10">
												<h4 class="list-group-item-title">
													<a onclick="estimate('${i.estimateNO}','${i.userID}')"
														data-toggle="modal" data-target="#estimatedetail">${i.userID }</a>
												</h4>
												<p class="list-group-item-text text-truncate">${i.epay }</p>
												<p class="list-group-item-text">${i.earea }</p>
											</div>
										</div>
									</div>
									<div class="list-group-item-figure">
